...
- `roles/storage_jellyfin_layout`: Creates configured Jellyfin library directories on storage hosts.
...
- `roles/jellyfin`: Deploys Jellyfin via Docker Compose on app VMs, mounting configured media libraries read-only.
